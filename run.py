...
# --- แมปชื่อคลังปลายทาง (เพิ่มแก้ไขชื่อตรงนี้ได้เลย) ---
plant_map = {
...
def get_plant_name(code):
    code = str(code).strip()
    if len(code) > 4: return code # ถ้ามีชื่อต่อท้ายอยู่แล้วก็ไม่ต้องเปลี่ยน
    return plant_map.get(code, code) # ถ้ามีแค่ 4 ตัวอักษร ให้แปลตามคู่มือ
